...
Training Data: 250 frames from the autonomous car's driving on  Town 1 (```VQA-AD/src/Training Data/```) 
Test Data: 100 frames from the autonomous car's driving on Town 1 and Town 2 (```VQA-AD/src/Testing Data/```) 
