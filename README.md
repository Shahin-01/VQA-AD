...
## Implications
By using our framework, you can easily test your simulation-based or even real autonomous driving scenes as well. In this case, make sure that you annotate other actions categories with the relevant QA pairs that are not listed above.
