...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dir', type=str, default='/home/shahin/Documents/VQA_AD/COCO-2015',
                        help='directory for inputs')

    parser.add_argument('--output_dir', type=str, default='/home/shahin/Documents/VQA_AD/COCO-2015/datasets',
